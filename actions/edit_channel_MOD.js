module.exports = {
	...
	<div>
		<div style="float: left; width: 35%;">
			...
			<select id="toChange" class="round">
				...
				<option value="rateLimitPerUser">Rate Limit Per User</option>
			</select>
		</div><br>
	<div>
	...
	action: function(cache) {
		...
		} else if(data.toChange === "rateLimitPerUser") {
			channel.setRateLimitPerUser(parseInt(newState)); //Added by Lasse in 1.9
		} else {
